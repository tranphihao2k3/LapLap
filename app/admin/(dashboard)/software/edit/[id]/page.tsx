...
export default function EditSoftwarePage({ params }: { params: Promise<{ id: string }> }) {
        ...
        const fetchSoftware = async () => {
            try {
                ...
                if (data.success) {
                    ...
                    showToast('Không tìm thấy phần mềm', 'error');
                    setTimeout(() => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data.success) {
                showToast('Cập nhật phần mềm thành công!', 'success');
                setTimeout(() => {
                    router.push('/admin/software');
                }, 1000);
            } else {
            ...
            showToast('Có lỗi xảy ra khi cập nhật phần mềm', 'error');
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="min-h-screen bg-gray-50 pb-12">
            ...
            <div className="container mx-auto max-w-5xl p-6">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <h1 className="text-2xl font-bold text-gray-800">Chỉnh sửa phần mềm</h1>
                </div>
