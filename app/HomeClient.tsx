    ...
    return (
        <main className="flex-1">
                ...
                <div className="relative z-10 h-full flex items-center">
                    <div className="container mx-auto max-w-5xl px-4 h-full flex flex-col justify-center">
                        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                            <motion.div className="flex-1 text-center lg:text-left z-10" initial="hidden" animate="visible" variants={stagger}>
                                ...
                                <motion.h1 variants={fadeInUp} className="text-2xl md:text-4xl font-bold text-white mb-4 leading-tight tracking-tight">Laptop Cũ Cần Thơ<br /><span className="text-cyan-300">LapLap - Uy Tín & Giá Rẻ</span></motion.h1>
                                <motion.p variants={fadeInUp} className="text-sm md:text-base text-blue-100/90 mb-6 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">Hệ thống mua bán <strong>laptop cũ Cần Thơ</strong> & laptop mới chính hãng giá tốt nhất. Dịch vụ sửa chữa, vệ sinh máy lấy liền chuyên nghiệp.</motion.p>
                                <motion.div variants={fadeInUp} className="flex flex-wrap items-center justify-center lg:justify-start gap-4 mb-8">
                                    <Button href="/laptops" variant="white" size="md" rightIcon="→" className="min-w-[140px] shadow-lg shadow-black/20">MUA NGAY</Button>
                                    <Button href="/test" variant="glass" size="md" className="min-w-[140px] border-white/30 hover:bg-white/10">TEST MÁY</Button>
                                </motion.div>
                            ...
                            <motion.div className="hidden md:flex flex-1 justify-center items-center relative w-full" initial={{ opacity: 0, scale: 0.9, y: 30 }} animate={{ opacity: 1, scale: 1, y: 0 }} transition={{ duration: 1, delay: 0.2 }}>
                                <div className="relative w-full max-w-[450px] h-[280px] md:h-[400px]">
                                    ...
                                    <Image src="https://bizweb.dktcdn.net/thumb/grande/100/512/769/products/alienware-x16-r2-3.jpg?v=1716871837957" alt="High-end Gaming Laptop" fill priority className="object-contain drop-shadow-[0_25px_50px_rgba(0,0,0,0.5)] animate-float relative z-10" />
                                </div>
                            </motion.div>
                        </div>
                    </div>
            ...
            <div className="container mx-auto max-w-5xl px-4 py-12 space-y-12">
                <motion.section className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
...
function BenefitCard({ icon: Icon, title, color }: any) {
    ...
    return (
        <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className={`group bg-gradient-to-br ${colors[color]} p-4 md:p-6 rounded-2xl shadow-lg border hover:shadow-2xl transition-all flex flex-col items-center text-center`}>
            <div className={`w-10 h-10 md:w-14 md:h-14 bg-white/50 rounded-full flex items-center justify-center mb-3 group-hover:scale-110 transition-transform`}><Icon className="w-5 h-5 md:w-7 md:h-7" /></div>
