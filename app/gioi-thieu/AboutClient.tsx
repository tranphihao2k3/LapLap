...
export default function AboutClient() {
  ...
  const Card3D = ({
    ...
    <motion.div
      variants={fadeInUp}
      className="bg-white/5 backdrop-blur-sm p-8 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors group"
    >
      <div
        className={`w-16 h-16 rounded-2xl bg-white/10 flex items-center justify-center mb-6 text-white group-hover:scale-110 transition-transform duration-300`}
      >
  ...
  return (
    <main className="min-h-screen bg-slate-50 font-sans overflow-hidden">
      ...
      <section
        ref={targetRef}
        className="relative w-full h-auto bg-gradient-to-r from-[#124A84] via-[#0d3560] to-[#0a2d54] text-white overflow-hidden shadow-lg border-b border-white/10 py-12 md:py-20"
      >
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-5xl relative z-20">
          ...
          >
            <motion.span
              variants={fadeInUp}
              className="inline-block px-4 py-1.5 rounded-full bg-white/20 backdrop-blur-md text-blue-100 border border-white/20 text-sm font-semibold tracking-wider mb-6"
            >
              GIỚI THIỆU LAPLAP
            </motion.span>
            <motion.h1
            ...
            >
              Kiến tạo{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-indigo-300 uppercase">
                Tương lai
              </span>{" "}
              <br />
            ...
            <motion.p
              variants={fadeInUp}
              className="text-lg md:text-xl text-blue-100 mb-10 leading-relaxed max-w-2xl mx-auto font-medium"
            >
              "Không chỉ bán Laptop, chúng tôi trao giải pháp và niềm tin cho
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                <p>
                  Được thành lập bởi founder Trần Phi Hào từ năm 2020 tại Cần
                  Thơ.
                </p>
                <p className="border-l-4 border-blue-500 pl-4 py-2 bg-blue-50/50 italic">
                  "Uy tín đến từ hàng nghìn khách hàng tin tưởng."
                </p>
              </div>
            </motion.div>
            <motion.div
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          ...
          >
            <Card3D
              ...
              title="Sứ Mệnh"
              color="text-blue-400"
              desc="Đơn giản hóa việc tiếp cận công nghệ cho mọi người."
            />
            <Card3D
              icon={Eye}
              title="Tầm Nhìn"
              color="text-purple-400"
              desc="Trở thành biểu tượng niềm tin số 1 tại Miền Tây."
            />
            <Card3D
              icon={Heart}
              title="Giá Trị"
              color="text-red-400"
              desc="TẬN TÂM - TRUNG THỰC - TRÁCH NHIỆM."
            />
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <ServiceCard
              ...
              desc="Laptop nhập khẩu Mỹ, Nhật tuyển chọn."
              link="/laptops"
              delay={0}
            />
            <ServiceCard
              icon={Zap}
              title="Sửa chữa"
              desc="Trung tâm bảo hành chuyên sâu."
            ...
            <ServiceCard
              icon={TrendingUp}
              title="Nâng cấp"
              desc="Vệ sinh, nâng cấp linh kiện chính hãng."
              link="/ve-sinh-laptop"
              delay={0.4}
            />
          </div>
      ...
      <section
        id="contact"
        className="py-16 md:py-20 bg-gradient-to-br from-blue-900 to-indigo-900 text-white"
      >
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="bg-white/10 backdrop-blur-md rounded-3xl p-10 border border-white/20 text-center">
            ...
            <p className="text-blue-100 mb-8">
              Hãy ghé thăm showroom hoặc liên hệ Hotline để được hỗ trợ tốt
              nhất.
            </p>
            <div className="flex flex-col sm:flex-row gap-10 justify-center items-center">
              ...
              <Button href="/laptops" variant="white" size="xl">
                Mua ngay
              </Button>
            </div>
          </div>
