...
export default function Header() {
  ...
  return (
    <header
      className={`w-full sticky top-0 z-50 shadow-md bg-white transition-transform duration-300 ${isVisible ? "translate-y-0" : "-translate-y-full"} ${isMobileMenuOpen ? "z-[9998]" : ""}`}
    >
      {/* Logo */}
        ...
        <div className="container mx-auto max-w-7xl px-4 py-3 flex flex-wrap md:flex-row justify-between items-center gap-y-4 md:gap-6">
              ...
              >
                {"Lap Lap Store".split("").map((char, index) => (
                  <motion.span
                    key={index}
                    className={
                      " text-3xl font-black text-gray-800 cursor-pointer inline-block"
                    }
                    animate={{
                      color: [
                        "#1f2937",
                      ...
                      {isLoading ? (
                            ...
                            >
                              ...
                              >
                                ...
                                <div className="flex-1 min-w-0">
                                  <h4
                                    className={`text-sm font-bold text-gray-800 line-clamp-1 group-hover:text-blue-600 transition-colors uppercase tracking-tight`}
                                  >
                                    {product.name}
                                  </h4>
                        ...
                        <div className="p-12 text-center">
                          ...
                          <p className="text-[10px] text-gray-400 mt-1">
                            Hãy thử từ khóa khác như "Dell XPS" hoặc "Nitro 5"
                          </p>
                        </div>
                      ) : null}
                    </div>
          ...
          <div className="flex items-center gap-2 sm:gap-4 order-2 md:order-none ml-auto md:ml-0">
            ...
            <div className="relative">
              ...
              >
                <ShoppingBag
                  className={`w-6 h-6 transition-colors ${isCartBumping ? "text-blue-600" : "text-gray-700"}`}
                />
                {totalItems > 0 && (
                  <motion.div
                    initial={{ scale: 0 }}
                  ...
                  >
                    ...
                    {item.children && (
                      <svg
                        ...
                        className={`w-3 h-3 transition-transform duration-200 ${hoveredIndex === index ? "rotate-180" : ""}`}
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
