...
const SERVICE_TYPE_ENUM = ["repair", "cleaning", "upgrade", "warranty", "inspection"];
const SERVICE_STATUS_ENUM = ["pending", "diagnosing", "in_progress", "waiting_parts", "completed", "cancelled"];
